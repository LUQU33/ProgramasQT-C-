...
Q_CONSTINIT const QMetaObject Formulario::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFormularioENDCLASS_t,
        ...
        // method 'nuevaPersonaAgregada'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<DatosPersona, std::false_type>,
        // method 'Enviar'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'Cerrar'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
...
void Formulario::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->nuevaPersonaAgregada((*reinterpret_cast< std::add_pointer_t<DatosPersona>>(_a[1]))); break;
        case 1: _t->Enviar(); break;
        case 2: _t->Cerrar(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Formulario::*)(DatosPersona );
            if (_t _q_method = &Formulario::nuevaPersonaAgregada; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Formulario::nuevaPersonaAgregada(DatosPersona _t1)
{
